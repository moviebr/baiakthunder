...
function premium.onSay(player, words, param)
    local var = "[Sell Points System] Este documento vale %s points para você usar no site."
    ...
    item:setAttribute(ITEM_ATTRIBUTE_DESCRIPTION, var:format(tonumber(param)))
    print(points)
    print(param)
    player:setPremiumPoints(points - tonumber(param))
