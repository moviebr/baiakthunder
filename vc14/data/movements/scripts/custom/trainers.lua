local config = {
	first_room_pos = {x = 216, y = 1261, z = 8}, -- posicao da primeira pos (linha 1 coluna 1)
	distX= 16, -- distancia em X entre cada sala (de uma mesma linha)
	distY= 15, -- distancia em Y entre cada sala (de uma mesma coluna)
	rX= 10, -- numero de colunas
